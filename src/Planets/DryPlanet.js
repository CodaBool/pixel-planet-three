...
const fragmentShader = () => {
    return `
        ...
        void main() {
            ...
            // noise
            float f = fbm(uv*size+vec2(time*time_speed*0.1, 0.0));
...
export function createDryPlanet(lightPos = new Vector2(0.39, 0.7), colors, rotationSpeed = 0.1, rotation = 0.0, pixels, seed) {
