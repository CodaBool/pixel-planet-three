    ...
    return `
        ...
        void main() {
            ...
            for(int i = 0; i < 15; i++) {
                ...
                c += circle(circleUV*size -time * .1 * time_speed - (1.0/d) * 0.1 + r);
            }
...
export function createStarBlobLayer(rotationSpeed = 0.1, colors, pixels, seed) {

    let colorPalette = [ new Vector4(255/255, 165/255, 0/255, 1) ]
