...
const fragmentShaderPlanet = () => {
    return `
        ...
        void main() {
            ...
            float n = cells(pixelized - vec2(time * time_speed * .2, 0), 10.0);
            n *= cells(pixelized - vec2(time * time_speed * .1, 0), 20.0);
...
export function createStar(lightPos = new Vector2(0.39, 0.7), lightIntensity = 0.1, rotationSpeed = 0.01, rotation = 0.0, colors, pixels, seed) {
